defmodule PhoenixKitLocations.ActivityLogAssertions do
  @moduledoc """
  Helpers for asserting activity log entries landed with the right
  action, module, and metadata shape.

  Imported into `PhoenixKitLocations.DataCase` and
  `PhoenixKitLocations.LiveCase` so every DB-backed test can reach
  them.
  """
  ...
  ## Example
      ...
      assert_activity_logged("location.created",
        ...
        metadata_has: %{"name" => "HQ", "status" => "active"}
      )
  """
